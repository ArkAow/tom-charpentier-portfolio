...
export default function Experience() {
    return (
        <div id="experience" className="relative w-screen flex flex-col items-left justify-left mt-16 p-10">
            <div className="absolute inset-0  top-[2rem] -left-24 -rotate-[6deg] transform bg-[url('/res/dot.svg')] bg-repeat bg-[length:20px_20px] opacity-20 -z-10" 
                style={{ width: "150%", height: "19%" }} />

            <div className="absolute inset-0  top-[40rem] -left-24 rotate-[9deg] transform bg-[url('/res/dot.svg')] bg-repeat bg-[length:20px_20px] opacity-20 -z-10" 
                style={{ width: "150%", height: "19%" }} />

            <div className="relative">
                <h1 className="text-4xl font-bold pb-12">My Experience</h1>
                <p className="text-justify md:pr-20 w-1/2">
